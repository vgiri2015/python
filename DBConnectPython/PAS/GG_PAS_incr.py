...
createHiveORCingestion="C:\\SVNCodeBase\\LegacyArchival-DataAcquistition\\dev\\coding\\GoldenGate\\PAS\\incremental\\PAScreateHiveORCingestionStmt_incr.hql"
...
for tableName in input_file:
    ...
    HiveORCingestion_file.write(ingestionStmt[0]+' '+ingestionStmt[1]+hiveORCSchema+tableName[1]+ingestionStmt[2]+'SELECT '+gg_columns[0]+','+gg_columns[1]+','+','.join(getColNames)+ingestionStmt[3]+hiveAVROSchema+tableName[1]+conditionStmt[0]+';'+'\n'+'\n')
    getColValTypes=[]
    getColNames=[]
